...
export const r1Questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: {
      why: "The Lifetime Learning Credit is nonrefundable, meaning it can reduce tax liability to zero but cannot generate a refund. The EITC and parts of the CTC and AOTC are refundable.",
